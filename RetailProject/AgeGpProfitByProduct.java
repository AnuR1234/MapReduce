...
public class AgeGpProfitByProduct extends Configured implements Tool
{
   //Map class
   ...
   public int run(String[] arg) throws Exception
   {
	  ...
	  job.setJarByClass(AgeGpProfitByProduct.class);
	  job.setJobName("AgeGpProgitByProduct");
   ...
   {
      ToolRunner.run(new Configuration(), new AgeGpProfitByProduct(),ar);
      System.exit(0);
   }
}
