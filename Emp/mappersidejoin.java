...
public class mappersidejoin {
	...
	public static class MyMapper extends Mapper<LongWritable,Text, Text, Text> {
		...
		protected void setup(Context context) throws java.io.IOException, InterruptedException{
		    ...
		    FileSystem fs = FileSystem.get(context.getConfiguration());	//configure as hdfs files	    
...
//				BufferedReader reader = new BufferedReader(new FileReader(p1.toString()));
  ...
  public static void main(String[] args) 
    ...
    job.addCacheFile(new Path(args[1]).toUri());//to store the cache files in some random location in the ram
